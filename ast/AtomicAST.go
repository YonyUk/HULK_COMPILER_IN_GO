...
func NewAtomicAST(symbol string, line int, column int, value interface{}) *AtomicAST {
	return &AtomicAST{
		value: value,
		BaseAST: BaseAST{
			Line:   line,
...
func (a *AtomicAST) Eval(context IContext, collector IErrorCollector) interface{} {
	return a.value
}
